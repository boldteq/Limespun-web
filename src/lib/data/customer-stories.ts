...
export interface CustomerStory {
  ...
  preLimespun: CustomerStorySection;
...
export const customerStories: CustomerStory[] = [
  {
    ...
    fullQuote:
      "We used to lose forty minutes every morning to app-switching. Now I open Today and the schedule's loaded before my coffee. The first time we caught a red-ink allergy from the kiosk update before the chair, I knew we'd never go back. Limespun isn't software for tattoo — it's the studio held in one place.",
    metricsCallout:
  ...
  },
  {
    ...
    migration: {
      heading: "The move",
      body: "Two days. Day one: Limespun imported her spreadsheet and matched every ink to its supplier SDS sheet automatically. Day two: she worked through the forty unfinished inks using Limespun's guided pigment registration flow — an hour and forty minutes for all forty. By end of day two, every bottle had a lot number, a risk flag, and a REACH status. The incident report she'd spent three hours on in December now generates in forty seconds.",
    },
    workflowToday: {
      heading: "Now",
      body: "Every session starts with an intake update at the kiosk: skin type, prior reactions, ink sensitivities. Asha selects the inks for the session from a pre-filtered list — anything flagged as high-pigment-load for sensitive skin is amber. Post-session, Limespun auto-logs the inks used against the client record. If the NVWA ever asks, the incident report is a single export. Asha hasn't rebuilt a compliance record from scratch since February 2026.",
    },
    fullQuote:
      "REACH compliance was the unlock. Every bottle on a registry, every reaction logged. I sleep better. Before Limespun I was one audit away from not being able to answer a regulator's questions. Now I can pull any client's full ink exposure history in thirty seconds. That's what solo compliance looks like when the tool is actually built for it.",
    metricsCallout:
  ...
  },
  {
    ...
    migration: {
      heading: "The move",
      body: "Salt House migrated on a Monday in January 2026. Tomas spent the afternoon with Limespun onboarding, imported his existing resident calendar, and built the first guest residency template — dates, deposit amount, consent kit, booking-page settings. End-to-end, twelve minutes. He tested it by setting up the February guest as a dry run. The booking page went live, the confirmation email went out, and Tomas went to dinner. No Tuesday-night calls.",
    },
    workflowToday: {
      heading: "Now",
      body: "When a guest enquires, Tomas opens Guest Residency, fills in name, dates, and style tags, and publishes. Limespun generates a unique booking page, links the consent kit, and sets the deposit threshold. The guest gets an onboarding email with everything they need. During the residency, their bookings flow into the main Salt House calendar — no separate system. Post-residency, Limespun archives their full client and booking history. Eleven residencies in 2025. Zero no-shows. Zero scheduling conflicts.",
    },
    fullQuote:
  ...
  },
  {
    ...
    migration: {
      heading: "The move",
      body: "Three days. Limespun's AI brief engine doesn't replace Lin's aesthetic judgment — it assembles the raw material. Day one: import. Day two: Lin ran the brief generator on three existing client files, compared the output to her manual briefs, and found it was matching her colour-palette logic at about 85%. Day three: she mapped her own taxonomy tags — 'studied emptiness', 'wash transition', 'negative space hold' — to the generator's prompts. From day four, briefs started as Limespun outputs and finished as Lin's work.",
    },
    workflowToday: {
      heading: "Now",
      body: "Brief generation starts with a client profile — past sessions, skin tone, stated reference images. Limespun produces a palette (six colours with ratios), a line-weight recommendation, and a reference cluster. Lin reviews in twelve minutes and marks up in Limespun's canvas. Total prep time per brief: twenty-two minutes average, down from forty-eight. Eighteen briefs a week at twenty-two minutes is six and a half hours. The nine hours she recovered went back to making work.",
    },
    fullQuote:
  ...
  },
  {
    ...
    migration: {
      heading: "The move",
      body: "Iron + Ash migrated over four days in September 2025. Limespun pulled every artist's existing Stripe account into Stripe Connect, mapped each split percentage, and ran a two-week parallel — Limespun calculated splits alongside Marcus's manual process. In week one, the two outputs matched to the dollar on seven of eight artists; the eighth had a tip-rounding discrepancy of $3.20. Marcus found it because Limespun flagged it. On day fifteen, Marcus cancelled his Friday calendar block.",
    },
    workflowToday: {
      heading: "Now",
      body: "Commissions calculate at session close and hit Stripe Connect automatically. Eight artists, no spreadsheet, no Friday block. Artists see their running totals in the Limespun app in real time. Marcus's Monday morning starts with a single commission dashboard: week total, per-artist breakdown, pending payouts. If a tip was split differently, Limespun flags it for review — not for Marcus to catch manually. The $140 incident hasn't repeated.",
    },
    fullQuote:
      "Commission splits used to be Friday afternoon. Now they hit Stripe Connect on the invoice. We got our weekends back. Before Limespun, Friday was three hours of mental overhead I couldn't avoid. The first time I walked out of the studio at 5 pm on a Friday without opening a spreadsheet, I called my wife and told her we had a different business now.",
    metricsCallout:
  ...
  },
  {
    ...
    migration: {
      heading: "The move",
      body: "Same day. Jonah's migration was the simplest on record: no prior booking system to import, just a decision to start clean. He set up his intake form, connected his payment account, and uploaded his ink inventory in one afternoon. The first booking through Limespun came in that evening — a referral from an existing client, booked through the new client page Jonah had published four hours earlier. He replied with a single confirmation tap.",
    },
    workflowToday: {
      heading: "Now",
      body: "Twelve sessions a week, under three hours of admin. Enquiries come through the Limespun client page and auto-sort by session type. Deposits process automatically. Consent is sent the day before and signed digitally. Session notes — ink used, mix ratios, healed percentage — log in Limespun during the session on an iPad on the trolley. When the client from eight months ago came back in March 2026 asking about the grey, Jonah had the ink name, ratio, and the reference photo pulled in twelve seconds.",
    },
    fullQuote:
      "I don't run a business, I make tattoos. Limespun understood that. Every screen does its job and stays out of the way. Twelve sessions a week, under three hours of admin. The first time I pulled a grey mix from eight months ago in twelve seconds while the client was still describing it — that was the moment I stopped thinking about the software and started just using it.",
    metricsCallout:
