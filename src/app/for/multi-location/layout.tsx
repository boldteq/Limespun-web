...
export const metadata: Metadata = {
  ...
  description:
    `Tattoo studio software for chains and franchises. Unlimited artists and locations, reports across every shop, API with webhooks, dedicated account manager. Multi-Location plan, ${MULTI_PRICE}/mo flat, not per location.`,
  openGraph: {
