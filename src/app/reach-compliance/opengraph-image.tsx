...
export const alt = "Limespun EU REACH Compliance — EU REACH 2022, built in.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          EU REACH 2022,{" "}
          <span style={{ fontStyle: "italic", color: "#C8351F" }}>built in</span>
          .
        </div>
        ...
        >
          ...
          >
            Inspector report &lt; 30s · Every plan
          </span>
        </div>
      </div>
    ),
