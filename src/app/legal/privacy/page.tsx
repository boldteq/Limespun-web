...
const sections: LegalSection[] = [
  {
    heading: "Who we are",
    body: "Limespun is a product of Boldteq Holdings Ltd, a company registered in the United Kingdom (registration number forthcoming). We are the data controller for personal data processed through this website (limespun.com). For data processed inside the Limespun application by your studio, your studio is the data controller and Boldteq acts as a data processor under a Data Processing Agreement.",
  },
  {
    heading: "What we collect on this website",
    body: [
      "When you visit limespun.com, we automatically collect basic technical data: IP address, browser type, pages visited, timestamps, and referrer URL. This is standard server log data and is retained for 30 days for security and analytics purposes.",
  ...
  {
    heading: "What Limespun the application collects",
    body: [
      "Inside the application (app.limespun.com), your studio enters data about its operations: clients, bookings, deposits, photos, consent forms, inventory, and communications. Boldteq processes this data on your studio's behalf as instructed in the Data Processing Agreement.",
  ...
  },
  {
    ...
    body: [
      ...
      "Application data: to operate the Limespun service for your studio. This includes processing payments via Stripe, sending communications via Twilio (SMS) and Resend (email), and syncing real-time data via Supabase.",
  ...
  {
    heading: "Children",
    body: "Limespun is not directed to children under 16. We do not knowingly collect personal data from children. If you believe a child has provided us with data, please email privacy@boldteq.com and we will delete it promptly.",
  },
  {
    heading: "Changes to this policy",
    body: "We will notify you of material changes to this policy by email (for application customers) and via a banner on limespun.com for at least 30 days before the change takes effect. The 'effective' date at the top of this page reflects the latest version.",
  },
];
